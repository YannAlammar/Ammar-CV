...
<template>
  <footer id="kontak" class="bg-gray-800 text-white border-t border-gray-700">
    <div class="container mx-auto px-6 py-12">

      <div class="md:flex md:justify-between md:items-center text-center md:text-left">

        <div class="mb-8 md:mb-0">
          <h3 class="text-3xl font-bold text-white mb-2">Hubungi Saya</h3>
          <p class="text-lg text-gray-400 mb-6">
            Jangan ragu untuk terhubung atau bertanya.
          </p>
          <a
            href="mailto:abyanhisyamm@gmail.com"
            class="bg-blue-600 text-white font-bold py-3 px-8 rounded-lg hover:bg-blue-700 transform hover:-translate-y-1 transition-all duration-300 inline-block shadow-lg hover:shadow-blue-500/50"
          >
            Kirim Email
          </a>
        </div>
        ...
        <div class="flex flex-col items-center md:items-end">
          ...
          <div class="flex justify-center space-x-6 mb-6">
            <a
              href="https://github.com/YannAlammar"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/lavinaasrya/"
              target="_blank"
              rel="noopener noreferrer"
              class="text-gray-400 hover:text-blue-500 transform hover:scale-110 transition-all duration-300"
          ...
          <p class="text-gray-500 text-sm">
            &copy; {{ currentYear }} Abyan Hisyam Al'ammar.
          </p>
        </div>
